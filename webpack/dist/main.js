// CHECK:: @@@@@@@@@@@ npx webpack --mode development --entry ./src/app.js -o ./dist 로 생성한 dist @@@@@@@@@@@@@@@
// CHECK:: 우리가 생성한 plus 함수가 들어있다
